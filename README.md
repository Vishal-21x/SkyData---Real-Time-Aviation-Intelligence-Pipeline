...
![Docker UI](<img width="2159" height="480" alt="image" src="https://github.com/user-attachments/assets/90a44da2-c493-4549-91ed-8df9fdf52b80" />
)

### Airflow DAG Pipeline Execution
![Airflow DAG](<img width="2530" height="913" alt="image" src="https://github.com/user-attachments/assets/cd2aebac-acc6-4f19-a503-52f4cc9a8ba6" />
)

### Snowflake Streamlit Dashboard
![Snowflake Dashboard](<img width="1395" height="713" alt="image" src="https://github.com/user-attachments/assets/e41f8efa-94c6-469f-8e3c-7621caacb2fd" />)
